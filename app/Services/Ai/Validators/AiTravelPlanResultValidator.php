...
class AiTravelPlanResultValidator
{
    ...
    public function validate(array $result, array $requestPayload): array
    {
        $validator = Validator::make(['result' => $result], [
            ...
            'result.estimated_budget' => ['required', 'integer:strict', 'min:0'],
            'result.days' => ['required', 'array', 'min:1'],
            'result.days.*' => ['required', 'array:day_number,date,title,items'],
            'result.days.*.day_number' => ['required', 'integer:strict', 'min:1'],
            ...
            'result.days.*.items.*.sort_order' => ['required', 'integer:strict', 'min:1'],
            ...
            'result.days.*.items.*.stay_minutes' => ['required', 'integer:strict', 'min:1'],
            'result.days.*.items.*.visit_cost' => ['required', 'integer:strict', 'min:0'],
            ...
            'result.days.*.items.*.transportation_cost' => ['required', 'integer:strict', 'min:0'],
